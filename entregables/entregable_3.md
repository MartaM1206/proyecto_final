...
Dado que los gráficos representan medias mensuales, no se distingue el impacto del confinamiento pero al ver los valores numéricos si se aprecia que el dióxido de nitrógeno. Para comprovar el efecto del confinamiento, se han representado los valores diarios de las estaciones elegidas entre febrero y junio de 2020 y, como se puede ver en la imagen, casi todos los contaminantes han caído, incluso a 0.
![alt text](image-4.png)
- **Análisis de impacto:** La mayor parte de la contaminación procede del tráfico, lo que resulta evidente al ver la caída de las medias diarias en los meses de confinaminento, quedando los contaminantes que se mantienen "de base", es decir, los que no proceden del tráfico, como los derivados de las calefacciones o las centrales térmicas y otras industrias.
...
- **Conclusiones:** Los datos muestran un descenso en los valores medios anuales, lo que sugiere que las medidas tomadas por el gobierno, como pueden ser las restricciones de tráfico, el fomento del transporte público o la sustitución de calderas antiguas por otras más eficientes han dado resultado.
- **Próximos pasos:** Ya que se dispone de medidas horarias, se podría analizar patrones diarios en cada estación, para identificar patrones horarios, horas críticas y zonas más problemáticas en las que intensificar las medidas preventivas.
